...
| 2026-08-03 | Model game launches as multiple targets       | itch.io releases can be used today while WebGL, Play Store, Steam, and GitHub launches remain additive. |
